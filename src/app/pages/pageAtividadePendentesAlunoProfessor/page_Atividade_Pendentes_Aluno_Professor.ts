...
@Component({
  selector: 'page_Atividade_Pendentes_Aluno_Professor',
  templateUrl: 'page_Atividade_Pendentes_Aluno_Professor.html',
  styleUrls: ['./page_Atividade_Pendentes_Aluno_Professor.scss']
})
export class Page_Atividade_Pendentes_Aluno_Professor implements AfterViewInit {
