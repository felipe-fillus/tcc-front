...
@Component({
  selector: 'page_Criar_Atividade_Silaba_Professor',
  templateUrl: 'page_Criar_Atividade_Silaba_Professor.html',
  styleUrls: ['./page_Criar_Atividade_Silaba_Professor.scss']
})
export class Page_Criar_Atividade_Silaba_Professor implements AfterViewInit {
