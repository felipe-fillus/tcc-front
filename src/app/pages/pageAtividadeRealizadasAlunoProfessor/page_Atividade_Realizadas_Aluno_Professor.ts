...
@Component({
  selector: 'page_Atividade_Realizadas_Aluno_Professor',
  templateUrl: 'page_Atividade_Realizadas_Aluno_Professor.html',
  styleUrls: ['./page_Atividade_Realizadas_Aluno_Professor.scss']
})
export class Page_Atividade_Realizadas_Aluno_Professor implements AfterViewInit {
  ...
  irVoltar() {
    this.router.navigateByUrl('/pageMeuAlunoProfessor');
  }
}
