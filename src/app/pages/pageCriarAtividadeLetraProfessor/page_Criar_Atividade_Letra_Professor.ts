...
@Component({
  selector: 'page_Criar_Atividade_Letra_Professor',
  templateUrl: 'page_Criar_Atividade_Letra_Professor.html',
  styleUrls: ['./page_Criar_Atividade_Letra_Professor.scss']
})
export class Page_Criar_Atividade_Letra_Professor implements AfterViewInit {
